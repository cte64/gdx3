...
public class MainMenu extends Component {
    ...
    public MainMenu() {
        ...
        newGame = new MenuItem("[type: menu][name: newGame]", "menuBack", background, "[vertical: top][horizontal: center]", 0, padding, 400, 50);
    ...
    public void update(Entity entity) {
        ...
        newGame.setXOffset( newGame.getXOffset() + 1);
